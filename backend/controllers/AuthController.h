...
public:
    ...
    // METHOD_ADD(AuthController::get, "/{2}/{1}", Get); // path is
    // /augventure/AuthController/{arg2}/{arg1}
    // METHOD_ADD(AuthController::your_method_name, "/{1}/{2}/list", Get); //
    // path is /augventure/AuthController/{arg1}/{arg2}/list
    // ADD_METHOD_TO(AuthController::your_method_name,
