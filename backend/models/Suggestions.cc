    ...
    const std::vector<std::string>& pMasqueradingVector) noexcept(false)
{
        ...
        pJson.isMember(pMasqueradingVector[1]))
    {
        ...
        if (!pJson[pMasqueradingVector[1]].isNull())
        {
            authorId_ = std::make_shared<uint32_t>(
                (uint32_t)pJson[pMasqueradingVector[1]].asUInt64());
        }
    }
        ...
        pJson.isMember(pMasqueradingVector[4]))
    {
        ...
        {
            votes_ = std::make_shared<int32_t>(
...
Suggestions::Suggestions(const Json::Value& pJson) noexcept(false)
{
    ...
    if (pJson.isMember("votes"))
    {
        ...
        {
            votes_ =
                std::make_shared<int32_t>((int32_t)pJson["votes"].asInt64());
        }
    }
}

void Suggestions::updateByMasqueradedJson(
    const Json::Value& pJson,
    const std::vector<std::string>& pMasqueradingVector) noexcept(false)
{
    if (pMasqueradingVector.size() != 5)
...
Suggestions::getPostDate() const noexcept
{
    return postDate_;
}
...
{
    static const std::vector<std::string> inCols = { "author_id", "post_date",
                                                     "sprint_id", "votes" };
    return inCols;
}
...
bool Suggestions::validateJsonForCreation(const Json::Value& pJson,
                                          std::string& err)
{
    if (pJson.isMember("id"))
    {
...
bool Suggestions::validateMasqueradedJsonForCreation(
    const Json::Value& pJson,
...
bool Suggestions::validateJsonForUpdate(const Json::Value& pJson,
                                        std::string& err)
{
    if (pJson.isMember("id"))
    {
...
bool Suggestions::validateMasqueradedJsonForUpdate(
    const Json::Value& pJson,
    const std::vector<std::string>& pMasqueradingVector, std::string& err)
{
    if (pMasqueradingVector.size() != 5)
...
bool Suggestions::validJsonOfField(size_t index, const std::string& fieldName,
                          ...
                          const ExceptionCallback& ecb) const
{
    const static std::string sql =
        "select * from posts where suggestion_id = ?";
