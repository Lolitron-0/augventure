    ...
    const std::vector<std::string>& pMasqueradingVector) noexcept(false)
{
        ...
        pJson.isMember(pMasqueradingVector[1]))
    {
        ...
        {
            tagId_ = std::make_shared<uint32_t>(
...
EventsTags::EventsTags(const Json::Value& pJson) noexcept(false)
{
    ...
    if (pJson.isMember("tag_id"))
    {
        ...
        {
            tagId_ = std::make_shared<uint32_t>(
                (uint32_t)pJson["tag_id"].asUInt64());
        }
    }
}

void EventsTags::updateByMasqueradedJson(
    const Json::Value& pJson,
    const std::vector<std::string>& pMasqueradingVector) noexcept(false)
{
    if (pMasqueradingVector.size() != 2)
...
{
    static const std::vector<std::string> inCols = { "event_id", "tag_id" };
    return inCols;
}
...
bool EventsTags::validateJsonForCreation(const Json::Value& pJson,
                                         std::string& err)
{
    if (pJson.isMember("event_id"))
    {
...
bool EventsTags::validateMasqueradedJsonForCreation(
    const Json::Value& pJson,
...
bool EventsTags::validateJsonForUpdate(const Json::Value& pJson,
                                       std::string& err)
{
    if (pJson.isMember("event_id"))
    {
...
bool EventsTags::validateMasqueradedJsonForUpdate(
    const Json::Value& pJson,
    const std::vector<std::string>& pMasqueradingVector, std::string& err)
{
    if (pMasqueradingVector.size() != 2)
...
bool EventsTags::validJsonOfField(size_t index, const std::string& fieldName,
