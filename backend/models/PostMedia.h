...
class PostMedia
{
  public:
     ...
     */
    explicit PostMedia(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PostMedia(const Json::Value &pJson) noexcept(false);
     ...
     */
    PostMedia(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const uint32_t &getValueOfPostId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint32_t> &getPostId() const noexcept;
    ///Set the value of the column post_id
    void setPostId(const uint32_t &pPostId) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<PostMedia>;
    friend drogon::orm::BaseBuilder<PostMedia, true, true>;
    friend drogon::orm::BaseBuilder<PostMedia, true, false>;
    friend drogon::orm::BaseBuilder<PostMedia, false, true>;
    friend drogon::orm::BaseBuilder<PostMedia, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<PostMedia>;
#endif
    ...
    std::shared_ptr<uint32_t> postId_;
    struct MetaData
    {
