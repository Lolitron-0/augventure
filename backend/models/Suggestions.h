...
class Suggestions
{
  public:
     ...
     */
    explicit Suggestions(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
     ...
     */
    Suggestions(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    ///Get the value of the column post_date, returns the default value if the column is null
    ...
    Users getAuthor(const drogon::orm::DbClientPtr &clientPtr) const;
    void getAuthor(const drogon::orm::DbClientPtr &clientPtr,
