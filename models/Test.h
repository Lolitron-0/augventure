...
class Test
{
  public:
     ...
     */
    explicit Test(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Test>;
    friend drogon::orm::BaseBuilder<Test, true, true>;
    friend drogon::orm::BaseBuilder<Test, true, false>;
    friend drogon::orm::BaseBuilder<Test, false, true>;
    friend drogon::orm::BaseBuilder<Test, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Test>;
#endif
